...
async def get_labels(text):
    ...
    # the API is sometime down so in case the API call fails, we give a equal 1 score to all categories
    try:
        headers = {
        ...
        rankings = {'business': 1, 'politics': 1, 'sport': 1, 'entertainment': 1, 'tech': 1}
        return rankings
